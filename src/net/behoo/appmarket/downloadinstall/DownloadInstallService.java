...
//	        String select = Downloads.COLUMN_NOTIFICATION_EXTRAS + "=?";
//			String[] selectArgs = {appInfo.mAppCode};
//			int delCount = getContentResolver().delete(Downloads.CONTENT_URI, select, selectArgs);
